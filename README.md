About composio-openai-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/composio-openai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/composio-openai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add composio-openai
# for installing globally
pixi global install composio-openai
```
...
It is possible to list all of the versions of `composio-openai` available on your platform:
...
```
pixi search composio-openai --channel conda-forge
```
